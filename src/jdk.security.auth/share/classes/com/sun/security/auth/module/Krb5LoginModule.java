...
public class Krb5LoginModule implements LoginModule {
    ...
    public boolean commit() throws LoginException {
        ...
        try {
            setupSubject(subject, isInitiator, ktab,
                unboundServer ? null : principal, storeKey ? encKeys : null);
            if (debug)
     ...
     *
     * @param isInitiator are we acting as a client
     *
     * @param cred the {@code Credentials} to store
     *
     ...
     *
     */
    private static void setupSubject(Subject subject, boolean isInitiator,
            KeyTab ktab, PrincipalName principal,
            EncryptionKey[] encKeys)
        throws LoginException {
        ...
        if (!isInitiator && encKeys == null && ktab == null)
